...
def feedback_form():
    st.markdown("<h2>Review dan Feedback</h2>", unsafe_allow_html=True)
    st.markdown(
        "Terima kasih telah menggunakan aplikasi ini! Kami sangat menghargai masukan dan tanggapan Anda untuk membantu meningkatkan kualitas aplikasi ini."
    )
    feedback_form_link = "https://forms.gle/c71Dj9zUrP79QTZw6"
    st.markdown(f'<a href="{feedback_form_link}" target="_blank"><button>Feedback</button></a>', unsafe_allow_html=True)
